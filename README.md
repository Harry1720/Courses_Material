...
:no_entry: **_Không phụ thuộc vào bộ tài liệu này để tránh chủ quan trong việc học, vì bài giảng & tài liệu của Thầy/Cô trên lớp là tốt nhất & đáng tin cậy nhất_** :no_entry:

:no_entry: **_Vui lòng không sử dụng bộ tài liệu này cho các mục đích ngoài việc học, nghiên cứu_** :no_entry:
