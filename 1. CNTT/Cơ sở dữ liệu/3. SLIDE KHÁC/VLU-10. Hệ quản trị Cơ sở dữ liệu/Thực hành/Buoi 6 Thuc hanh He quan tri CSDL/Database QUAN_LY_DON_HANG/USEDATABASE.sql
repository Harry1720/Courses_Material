...
('KH0004',N'Bình Tây',N'Công ty TMCP Bình Tây',N'234 Lê Lợi, Q1, HCM','binhtay@gmail.com','0238973455','02838273488'),
...
('NV003',N'Phạm Minh', N'Huyên','1986-3-6','2005-7-1',N'88 Cộng Hòa, Tân Bình, HCM','0945312722',10000000,1000000),
...
VALUES('1','M001',5000000,2,50000),
('2','M001',5000000,1,50000),
('2','M002',1000000,2,50000),
('3','M005',5000000,1,50000),
('3','M006',1000000,1,50000),
('3','M002',1000000,2,50000),
('3','M001',5000000,1,0),
('3','M003',500000,1,50000),
('3','M004',3000000,1,50000),
('3','M007',5000000,1,50000),
('3','M008',3000000,1,50000),
('6','M001',5000000,1,50000),
('6','M002',1000000,1,50000)
...
INSERT [dbo].[TEMP] ([MAKHACHHANG], [TENKHACHHANG], [Bàn máy tính], [Bàn ủi], [Tranh treo tường], [Máy sấy tóc], [Nồi cơm điện]) VALUES (N'KH0001', N'An Long', 2, NULL, NULL, NULL, NULL)
INSERT [dbo].[TEMP] ([MAKHACHHANG], [TENKHACHHANG], [Bàn máy tính], [Bàn ủi], [Tranh treo tường], [Máy sấy tóc], [Nồi cơm điện]) VALUES (N'KH0002', N'Phong Vũ', 1, 2, NULL, NULL, NULL)
INSERT [dbo].[TEMP] ([MAKHACHHANG], [TENKHACHHANG], [Bàn máy tính], [Bàn ủi], [Tranh treo tường], [Máy sấy tóc], [Nồi cơm điện]) VALUES (N'KH0003', N'Thanh Bình', 1, 2, 1, 1, 1)
INSERT [dbo].[TEMP] ([MAKHACHHANG], [TENKHACHHANG], [Bàn máy tính], [Bàn ủi], [Tranh treo tường], [Máy sấy tóc], [Nồi cơm điện]) VALUES (N'KH0004', N'Bình Tây', NULL, NULL, NULL, NULL, NULL)
