...
; (signed/unsigned)
; 4 is equal to 4
mov ah, 4    ;tu dong 15->62 la lenh de chay compare
mov al, 4
cmp ah, al
nop
...
game:  mov dx, offset msg1
       ...
       cmp al, '0'   ;so sanh ky tu 0=048 voi al
       jb stop
       ...
       cmp al, '5'
       jb below   ;neu so nhap vao <5 -> nhay den nhan below
       ja above
...
below_5 db " is below five!" , 0Dh,0Ah, "$"      ;doi so day noi dung al truoc chuoi is below 5...
